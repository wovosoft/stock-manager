    ...
    <div>
        ...
        >
            <b-card>
                ...
                <b-form-group :label="__('search_users','Search Users')">
                    <type-head api_url="/backend/users/search"
                               :placeholder="__('type_and_search_user','Type and Search User')"
                ...
                <b-form-group :label="__('search_permissions','Search Permissions')">
                    <type-head api_url="/backend/permissions/search"
                               :clear-on-select="true"
                               :placeholder="__('type_and_search_permission','Type and Search Permission')"
                               @selected="item=>{
                ...
                <div>
                    <button class="btn btn-sm btn-secondary m-1"
                            :title="__('click_to_remove','Click to Remove')"
        ...
        methods: {
            onSubmit() {
                if (!this.form.user || !this.form.permissions.length) {
                    alert(_t("please_fill_the_form_correctly", "Please Fill the form correctly"));
                    return false;
                }
