                ...
                <template v-slot:cell(action)="row">
                    <b-button-group size="sm">
                        <b-button variant="danger"
                                  :title="__('revoke_user','Revoke User')"
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                fields: [
                    ...
                    {key: 'email', sortable: true, visible: true, label: _t('email', 'Email')},
                    {
        ...
        methods: {
            ...
            detach(id) {
                this.$bvModal.msgBoxConfirm(_t('are_you_sure', 'Are you sure?'), {
                    title: _t('please_confirm', 'Please Confirm'),
                    size: 'sm',
                    buttonSize: 'sm',
                    okVariant: 'danger',
                    okTitle: _t('yes', 'YES'),
                    cancelTitle: _t('no', 'NO'),
                    footerClass: 'p-2',
