    ...
    <div class="row">
        <div class="col-md-4">
            <form @submit.prevent="onSubmit">
                ...
                <b-form-group :label="__('password','Password ')+ (!form.id ?'*':'')"
                              v-if="!form.id || (form.id && password_enabled)">
                ...
                <b-form-group :label="__('roles','Roles') +' *'">
                    <b-form-select
                        :required="true"
                        :options="roles"
                        v-model="temp_role"
                    ...
                    >
                        <b-form-select-option :value="null">
                            {{__('please_select_an_option','Please select an option')}}
                    ...
                    <b-button size="sm" class="m-1"
                              ...
                              :key="key" :title="__('click_to_remove','Click to Remove')">
                        <b-icon-x/>
                        {{role}}
                    </b-button>
                </b-form-group>
