...
<table style="width: 100%">
    ...
    <tr>
        <td colspan="6" style="text-align: center;background-color: #1b1b1b;color: white;">
            পণ্য ক্রয় ও অর্থ প্রদান প্রতিবেদন<br>
    ...
    <tr>
        <td colspan="2">মোট</td>
        <td>{{\App\Drivers\BanglaConverter::en2bn(number_format($items->sum('payable'),2))}} টাকা</td>
        <td>{{\App\Drivers\BanglaConverter::en2bn(number_format($items->sum('paid'),2))}} টাকা</td>
        <td>{{\App\Drivers\BanglaConverter::en2bn(number_format($items->sum('returned'),2))}} টাকা</td>
        <td>{{\App\Drivers\BanglaConverter::en2bn(number_format($items->sum('balance'),2))}} টাকা</td>
    </tr>
    </tbody>
</table>
