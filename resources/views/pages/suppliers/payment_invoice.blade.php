...
<head>
    ...
    <title>Supplier Payment Invoice # {{$payment->supplier->id}}</title>
    <style>
...
<table style="width: 100%">
    <tr>
        <td style="width: 50%;vertical-align: top;">
            ...
            সরবরাহকারীর নামঃ {{$payment->supplier->name}}<br>
            মোবাইল নং: {{\App\Drivers\BanglaConverter::en2bn($payment->supplier->phone)}}<br>
