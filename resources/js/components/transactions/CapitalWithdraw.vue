    ...
    <div>
        <b-row class="my-2">
            ...
            <b-col class="text-right">
                <b-button size="sm" variant="dark" v-b-modal:add-capital-withdraw>
        ...
        <b-modal id="add-capital-withdraw"
                 header-bg-variant="dark"
                 header-text-variant="light"
                 hide-footer
                 @hidden="resetForm"
                 :title="__('withdrawal_amount','Withdrawal Amount')">
...
<script>
    ...
    export default {
        ...
        watch: {
            "date": {
                handler() {
                    this.$refs.capitalWithdrawsList.refresh();
                }
            }
        },
        data() {
