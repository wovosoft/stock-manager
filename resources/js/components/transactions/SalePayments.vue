                ...
                <b-form @submit.prevent="handleSubmit(hide)">
                    <b-form-group :label="__('customer','Customer')">
                        <vue-select
                            ...
                            :api_url="route('Backend.Customers.SearchWithDues')"/>
                    </b-form-group>
                    <b-form-row>
                        <b-col md="6" sm="12">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getItems(ctx) {
                return axios.post(route('Backend.Payments.Sales.List', {page: ctx.currentPage}), {
                    date: this.date,
            ...
            handleSubmit(hide) {
                axios
                    .post(route('Backend.Customers.Payments.Add', {customer: this.employeeId}), this.form)
                    .then(res => {
                        hide();
