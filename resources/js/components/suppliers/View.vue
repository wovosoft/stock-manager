            ...
            <b-col md="3" sm="12">
                ...
                <table class="table table-sm table-bordered table-striped table-hover">
                    <tr v-for="$money in ['payable','returned','paid','balance']">
                        <th>{{__('purchases_'+$money,startCase('purchases_'+$money))}}</th>
            ...
            <b-col>
                <b-table small bordered hover striped
                    ...
                    <template v-slot:cell(value)="row">
                        ...
                        <template
                            v-else-if="['deposit_amount','withdrawn_amount','funds_balance','purchases_payable','purchases_paid','purchases_balance','final_balance'].includes(row.item.key)">
                ...
                <b-input-group>
                    ...
                    <template #append>
                        ...
                        <b-button
                            ...
                            target="_blank"
                            :href="route('Backend.Suppliers.Payments.shortFinancialReport',{supplier:the_item.id,type:'pdf',start_date:browse.start_date,end_date:browse.end_date}).url()">
                        ...
                        <b-button
                            ...
                            v-if="the_item && the_item.id"
                            target="_blank"
                            :href="route('Backend.Suppliers.Payments.fullFinancialReport',{supplier:the_item.id,type:'pdf',start_date:browse.start_date,end_date:browse.end_date}).url()">
