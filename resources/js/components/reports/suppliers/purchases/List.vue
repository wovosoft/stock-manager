    ...
    <div>
        ...
        <b-card body-class="p-0">
            <template #header>
                <b-row>
                    ...
                    <b-col class="text-center" md="2" sm="12">
                        ...
                        <b-button size="sm" variant="dark"
                                  target="_blank"
                                  :href="route('Backend.Reports.Suppliers.Purchases', {start_date: browse.start_date,end_date: browse.end_date,pdf:'pdf'})">
                            {{__('export',"Export")}}
                        </b-button>
                    </b-col>
                    <b-col md="6" sm="12">
            ...
            <b-table
                ...
                foot-clone
                foot-variant="light"
                :api-url="route('Backend.Reports.Suppliers.Purchases', {start_date: browse.start_date,end_date: browse.end_date,page:dt.current_page})">
